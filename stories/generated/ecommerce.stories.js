  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
E-commerce UI components and layouts

### Info & Metadata
- **Category**: Layout
- **Tags**: <code>ecommerce</code>, <code>shop</code>, <code>product</code>, <code>cart</code>, <code>store</code>
...
<section class="testimonial-section">
  ...
  <div class="container">
    ...
    <h2 class="section-title">
      <i class="fa-solid fa-heart" style="color: #ff4757;"></i> Customer Reviews
    </h2>
...
<footer class="ecommerce-footer">
  ...
  <section>
    ...
    <div class="container">
      ...
      <h2 class="section-title">
        <i class="fa-solid fa-sparkles"></i> E-commerce Features
      </h2>
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'E-commerce',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/ecommerce.css"],
