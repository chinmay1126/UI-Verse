  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Hero section layouts and banner designs

### Info & Metadata
- **Category**: Layout
- **Tags**: <code>hero</code>, <code>landing</code>, <code>banner</code>, <code>sections</code>
...
<p>
Explore hundreds of premium UI components.
</p>
...
<div class="hero-info">
  <h2>Minimal Portfolio Hero</h2>
  <p>
    A minimalist portfolio hero with elegant typography, soft abstract
    floating shapes, smooth spacing, and a refined creative studio vibe.
  </p>
</div>
<!-- =========================================================
10. MINIMAL PORTFOLIO HERO
========================================================= -->

<div class="hero-wrapper hero-portfolio">

  <div class="hp-circle hp-circle-1"></div>
  <div class="hp-circle hp-circle-2"></div>
  ...
  <div class="hp-content">
    ...
    <p class="hp-desc">
      Modern portfolio hero section with elegant typography,
      abstract floating shapes, and minimal aesthetics.
    </p>

    <div class="hp-btns">

      <button class="hp-btn-dark">
        View Portfolio
      </button>

      <button class="hp-btn-light">
        Contact Me
      </button>
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Hero Sections',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/home.css","/style.css","/shared-sidebar.css","/hero.css"],
