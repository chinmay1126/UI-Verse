  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Documentation and guide page templates

### Info & Metadata
- **Category**: Layout
- **Tags**: <code>docs</code>, <code>documentation</code>, <code>guide</code>, <code>reference</code>
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Documentation',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/documentation.css"],
