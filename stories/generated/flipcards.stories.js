...
export default {
  title: 'Components/3D Flip Cards',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: `
### Description
3D flip card components with hover effects

### Info & Metadata
- **Category**: Cards
- **Tags**: <code>cards</code>, <code>3d</code>, <code>animation</code>, <code>interactive</code>
...
export const Default = {
  render: () => createShadowRootStory({
    title: '3D Flip Cards',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/flipcards.css"],
    content: `
  <a class="skip-link" href="#main-content">Skip to main content</a>
