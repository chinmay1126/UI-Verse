...
### Info & Metadata
- **Category**: Forms
- **Tags**: <code>drag</code>, <code>drop</code>, <code>upload</code>, <code>files</code>, <code>interactive</code>
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Drag & Drop',
    styles: ["/design-tokens.css","/dist/shared.css","/files.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/playground.css"],
    content: `
  <a class="skip-link" href="#main-content">Skip to main content</a>
