  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Step indicator and stepper components

### Info & Metadata
- **Category**: Navigation
- **Tags**: <code>stepper</code>, <code>steps</code>, <code>progress</code>, <code>wizard</code>, <code>onboarding</code>
...
<div class="main-content">
  ...
  <header class="topbar">
    <div class="search-box">
      ...
      <input type="text" placeholder="Search stepper components..." id="searchInput" data-a11y-remediation="label-needed">
    </div>
    <div class="topbar-actions">
      <button class="add-btn" onclick="advanceAllSteps()" data-a11y-remediation="button-label-needed"><i class="fa-solid fa-play"></i> Advance All</button>
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Steppers',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/step-indicators.css"],
    content: `
  <a class="skip-link" href="#main-content">Skip to main content</a>
