  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Radio button styles and groups

### Info & Metadata
- **Category**: Forms
- **Tags**: <code>radio</code>, <code>buttons</code>, <code>controls</code>, <code>forms</code>
...
<div class="main-content">
  ...
  <header class="topbar">
    <div class="search-box">
      ...
      <input type="text" placeholder="Search components..." data-a11y-remediation="label-needed">
    </div>
    <div class="topbar-actions">
      <button class="add-btn" data-a11y-remediation="button-label-needed">
  ...
  <!-- ============ COMPONENT 11: IOS SEGMENT RADIO ============ -->
<div class="component-card">
  <div class="card-preview">
    <div class="ios-radio-group">
      <label class="ios-radio">
        <input type="radio" name="ios" checked>
        <span class="ios-pill">Daily</span>
      </label>

      <label class="ios-radio">
        <input type="radio" name="ios">
        <span class="ios-pill">Weekly</span>
      </label>

      <label class="ios-radio">
        <input type="radio" name="ios">
        <span class="ios-pill">Monthly</span>
      </label>
    </div>
  </div>
  ...
  <div class="card-content">
    <div class="card-top">
      <h3>iOS Segment Radio</h3>
      <span>Smooth</span>
    </div>

    <p>
      Apple-inspired segmented radio control with soft backgrounds
      and smooth active transitions.
    </p>
  ...
  <pre id="r11" class="code-block" style="display:none;"><code>&lt;label class="ios-radio"&gt;
  &lt;input type="radio" name="ios" checked&gt;
  &lt;span class="ios-pill"&gt;Daily&lt;/span&gt;
&lt;/label&gt;

.ios-radio input:checked ~ .ios-pill {
  background: #111827;
  color: #fff;
}</code></pre>
</div>

<!-- ============ COMPONENT 12: MUSIC PLAYER RADIO ============ -->
<div class="component-card">
  <div class="card-preview dark-preview">
    <div class="music-radio-group">
  ...
  <pre id="r12" class="code-block" style="display:none;"><code>&lt;label class="music-radio"&gt;
  &lt;input type="radio" name="music" checked&gt;
...
<!-- ============ COMPONENT 13: STATUS SELECT RADIO ============ -->
<div class="component-card">
  <div class="card-preview">
    <div class="status-radio-group">
      ...
      <label class="status-radio away">
        <input type="radio" name="status">
        <span class="status-dot"></span>
        <span class="status-label">Away</span>
      </label>

      <label class="status-radio busy">
        <input type="radio" name="status">
        <span class="status-dot"></span>
  ...
  <pre id="r13" class="code-block" style="display:none;"><code>&lt;label class="status-radio online"&gt;
  &lt;input type="radio" name="status" checked&gt;
  &lt;span class="status-dot"&gt;&lt;/span&gt;
  &lt;span class="status-label"&gt;Online&lt;/span&gt;
&lt;/label&gt;
...
<!-- ============ COMPONENT 14: IMAGE PICKER RADIO ============ -->
<div class="component-card">
  <div class="card-preview">
    <div class="image-radio-group">
      ...
      <label class="image-radio">
        ...
        <div class="image-card">
          <img src="https://picsum.photos/200/120?1" alt="">
          <span>Nature</span>
        </div>
      </label>
      ...
      <label class="image-radio">
        ...
        <div class="image-card">
          <img src="https://picsum.photos/200/120?2" alt="">
          <span>City</span>
        </div>
      </label>
  ...
  <pre id="r14" class="code-block" style="display:none;"><code>&lt;label class="image-radio"&gt;
  &lt;input type="radio" name="theme" checked&gt;
...
<!-- ============ COMPONENT 15: LIQUID RADIO BUTTON ============ -->
<div class="component-card">
  <div class="card-preview dark-preview">
    <div class="liquid-radio-group">

      <label class="liquid-radio">
        <input type="radio" name="liquid" checked>
        <span class="liquid-circle"></span>
        <span class="liquid-label">Ocean</span>
      </label>

      <label class="liquid-radio">
        <input type="radio" name="liquid">
        <span class="liquid-circle"></span>
        <span class="liquid-label">River</span>
      </label>

      <label class="liquid-radio">
        <input type="radio" name="liquid">
        <span class="liquid-circle"></span>
        <span class="liquid-label">Rain</span>
      </label>
  ...
  <pre id="r15" class="code-block" style="display:none;"><code>&lt;label class="liquid-radio"&gt;
  &lt;input type="radio" name="liquid" checked&gt;
  &lt;span class="liquid-circle"&gt;&lt;/span&gt;
&lt;/label&gt;
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Radio Buttons',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/radiobutton.css"],
    content: `
  <a class="skip-link" href="#main-content">Skip to main content</a>
