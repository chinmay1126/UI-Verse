  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Contact form and support page templates

### Info & Metadata
- **Category**: Forms
- **Tags**: <code>contact</code>, <code>form</code>, <code>email</code>, <code>support</code>
...
<li>
      ...
      <li>
        ...
        <input aria-label="Input field" type="text">
<input aria-label="Input field" type="email">
<input aria-label="Input field" type="checkbox">
<input aria-label="Input field" type="email">
    ...
    <div class="footer-container">
      ...
      <div class="footer-col newsletter">
        ...
        <div class="newsletter-form">
          <input aria-label="Input field" type="email" placeholder="your@email.com" />
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Contact Us',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/contact.css"],
    content: `
  <a class="skip-link" href="#main-content">Skip to main content</a>
