  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Error page templates and variants

### Info & Metadata
- **Category**: Layout
- **Tags**: <code>error</code>, <code>404</code>, <code>pages</code>, <code>status</code>
...
<main class="main-home">
  ...
  <div class="toolbar">
    <div class="toolbar-search">
      ...
      <input type="text" id="componentSearch" placeholder="Filter error components..." autocomplete="off" data-a11y-remediation="label-needed">
    </div>
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Error Pages',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/error.css"],
