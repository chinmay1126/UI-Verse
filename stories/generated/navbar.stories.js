  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Top navigation bars and variants

### Info & Metadata
- **Category**: Navigation
- **Tags**: <code>navigation</code>, <code>components</code>, <code>header</code>, <code>topbar</code>
...
<main class="main-home">
    ...
    <div class="filter-bar">
      ...
      <div class="filter-search">
        ...
        <input type="text" id="filterSearchInput" placeholder="Filter navbars..." oninput="liveFilter(this.value)" />
      </div>
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Navbar',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/navbar.css"],
