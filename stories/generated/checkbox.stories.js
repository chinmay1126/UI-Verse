  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Checkbox styles and interactive states

### Info & Metadata
- **Category**: Forms
- **Tags**: <code>checkbox</code>, <code>controls</code>, <code>forms</code>, <code>selection</code>
...
<main class="main-home">
    ...
    <header class="topbar">
      ...
      <div class="topbar-actions">
        ...
        <button class="add-btn" data-a11y-remediation="button-label-needed"><i class="fa-solid fa-plus"></i> Add Component</button>
...
&lt;/label&gt;</code></pre>
      ...
      <div class="component-card">
        ...
        <div class="card-content">
          <div class="card-top">
            <h3>Bookmark Checkbox</h3>
            <span>New</span>
          </div>
          <p>A sleek bookmark toggle for saving items with a smooth scale animation.</p>
          <div class="card-actions">
        ...
        <pre id="cb16" class="code-block" style="display:none;"><code>&lt;label class="bookmark-cb"&gt;
  &lt;input type="checkbox"&gt;
  &lt;span class="bookmark-box"&gt;&lt;i class="fa-regular fa-bookmark"&gt;&lt;/i&gt;&lt;/span&gt;
&lt;/label&gt;</code></pre>
      </div>
      ...
      <div class="component-card">
        ...
        <div class="card-content">
          <div class="card-top">
            <h3>Bell Notification Checkbox</h3>
            <span>Popular</span>
          </div>
          <p>A notification bell that wiggles and fills with color when checked.</p>
          <div class="card-actions">
        ...
        <pre id="cb17" class="code-block" style="display:none;"><code>&lt;label class="bell-cb"&gt;
  &lt;input type="checkbox"&gt;
  &lt;span class="bell-box"&gt;&lt;i class="fa-regular fa-bell"&gt;&lt;/i&gt;&lt;/span&gt;
&lt;/label&gt;</code></pre>
      </div>
      ...
      <div class="component-card">
        ...
        <div class="card-content">
          <div class="card-top">
            <h3>Star Rating Checkbox</h3>
            <span>Trending</span>
          </div>
          <p>A rating star that glows beautifully with an amber drop-shadow on activation.</p>
          <div class="card-actions">
        ...
        <pre id="cb18" class="code-block" style="display:none;"><code>&lt;label class="star-cb"&gt;
  &lt;input type="checkbox"&gt;
  &lt;span class="star-box"&gt;&lt;i class="fa-regular fa-star"&gt;&lt;/i&gt;&lt;/span&gt;
&lt;/label&gt;</code></pre>
      </div>
      ...
      <div class="component-card">
        ...
        <div class="card-content">
          <div class="card-top">
            <h3>Power Button Checkbox</h3>
            <span>Premium</span>
          </div>
          <p>A circular power toggle that mimics a real-world hardware button.</p>
          <div class="card-actions">
        ...
        <pre id="cb19" class="code-block" style="display:none;"><code>&lt;label class="power-cb"&gt;
  &lt;input type="checkbox"&gt;
  &lt;span class="power-box"&gt;&lt;i class="fa-solid fa-power-off"&gt;&lt;/i&gt;&lt;/span&gt;
&lt;/label&gt;</code></pre>
      </div>
      ...
      <div class="component-card">
        ...
        <div class="card-content">
          <div class="card-top">
            <h3>Check Circle Checkbox</h3>
            <span>Essential</span>
          </div>
          <p>A smooth filling circle that pops a checkmark when selected.</p>
          <div class="card-actions">
            <button onclick="toggleCode('cb20')"><i class="fa-solid fa-code"></i> View Code</button>
            <button onclick="copyCode('cb20')"><i class="fa-solid fa-copy"></i> Copy</button>
            <button><i class="fa-solid fa-bookmark"></i> Save</button>
          </div>
        </div>
        <pre id="cb20" class="code-block" style="display:none;"><code>&lt;label class="check-circle-cb"&gt;
  &lt;input type="checkbox"&gt;
  &lt;span class="check-circle-box"&gt;&lt;i class="fa-solid fa-check"&gt;&lt;/i&gt;&lt;/span&gt;
&lt;/label&gt;</code></pre>
      </div>
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Checkboxes',
    styles: ["/design-tokens.css","/style.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/checkbox.css"],
