  ...
  parameters: {
    docs: {
      description: {
        component: `
### Description
Search bar components and variants

### Info & Metadata
- **Category**: Forms
- **Tags**: <code>search</code>, <code>input</code>, <code>filter</code>, <code>components</code>
...
<main class="main-home">
  ...
  <div class="toolbar">
    <div class="toolbar-search">
      ...
      <input type="text" id="componentSearch" placeholder="Filter components..." autocomplete="off" data-a11y-remediation="label-needed">
    </div>

    <div class="sort-dropdown-wrapper" id="sortWrapper">
      <button class="sort-trigger" id="sortTrigger" onclick="toggleSortMenu()" data-a11y-remediation="button-label-needed">
  ...
  <div class="featured-content">
    <span class="badge">Featured Component</span>

    <h2>AI Search Interface</h2>

    <p>
      Modern search experience with command palette,
...
export const Default = {
  render: () => createShadowRootStory({
    title: 'Search Bars',
    styles: ["/design-tokens.css","/dist/shared.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css","/search.css"],
