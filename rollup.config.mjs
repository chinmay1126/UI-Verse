...
export default [
  ...
  // uv-tooltip
  {
    ...
    output: [
      ...
      {
        file: "dist/components/uv-tooltip.mjs",
        format: "esm",
        sourcemap: true,
      },
    ],
  ...
  // uv-language-switcher
  {
    ...
    output: [
      {
        file: "dist/components/uv-language-switcher.js",
        format: "esm",
        sourcemap: true,
      },
      {
        file: "dist/components/uv-language-switcher.mjs",
        format: "esm",
        sourcemap: true,
      },
    ],
  ...
  // uv-theme-switcher
  {
    ...
    output: [
      {
        file: "dist/components/uv-theme-switcher.js",
        format: "esm",
        sourcemap: true,
      },
      {
        file: "dist/components/uv-theme-switcher.mjs",
        format: "esm",
        sourcemap: true,
      },
    ],
  ...
  // uv-dropdown
  {
    ...
    output: [
      {
        file: "dist/components/uv-dropdown.js",
        format: "esm",
        sourcemap: true,
      },
      {
        file: "dist/components/uv-dropdown.mjs",
        format: "esm",
        sourcemap: true,
      },
    ],
