...
- Tags: error, 404, pages, status
- Description: Error page templates and variants

## Assets

- CSS: dist/shared.css, error.css, https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css
- JS: dist/shared.js
...
- H2: Access Denied
- H2: Network Error
- H2: Session Expired Screen
- H2: Payment Failed Page
