...
- Tags: navigation, components, header, topbar
- Description: Top navigation bars and variants

## Assets

- CSS: dist/shared.css, https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css, navbar.css
- JS: dist/shared.js, js/features/command-palette.js, navbar.js
